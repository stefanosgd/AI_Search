            ...
            if new_length[i] < self.worst:
                ...
                for j in range(self.loops):
                    if self.worst < self.tour_length[j]:
                        self.worst = self.tour_length[j]
                        self.worst_pos = j
                # print(self.worst_pos)
                # print(self.worst)
                # print("Tour length2=", self.tour_length)
